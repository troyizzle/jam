...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference("Bet.count") do
      post bets_url, params: { bet: { book: @bet.book, odds: @bet.odds, status: @bet.status, tailed: @bet.tailed, user_id: @bet.user_id } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { book: @bet.book, odds: @bet.odds, status: @bet.status, tailed: @bet.tailed, user_id: @bet.user_id } }
